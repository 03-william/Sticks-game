...
public class Main
{
	public static void main(String[] args) {
		...
		if(reader.nextInt() == 1)
		    ...
		    //game stops ehen we get to 0 sticks
		    //so the game must continue to run as long as the number of sticksis > 10
		    while(sticks >0){
		        if(turn)
		    ...
		    //this method has two input paramaters: sticls and reader
